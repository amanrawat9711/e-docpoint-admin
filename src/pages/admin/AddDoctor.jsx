...
const AddDoctor = () => {
  ...
  return (
    <form className="m-5 w-full" onSubmit={submitHandler}>
      ...
      <div className="bg-white px-8 py-8 border rounded w-full max-h-[80vh] overflow-y-scroll max-w-4xl">
        <div className="flex items-center mb-8 gap-4 text-gray-500">
          <label htmlFor="doc-img">
            <img
              className="w-16 rounded-full cursor-pointer bg-gray-100"
        ...
        <div>
          ...
          <textarea
            ...
            value={about}
            className="w-full border pt-2 rounded"
            placeholder="Write About Yourself"
            rows={5}
            required
          />
        </div>
        <button className="bg-indigo-500 px-8 mt-5 py-2 text-white rounded-full cursor-pointer">
          Add Doctor
        </button>
      </div>
    </form>
